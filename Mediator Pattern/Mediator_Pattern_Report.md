...
| :--- | :--- | :--- | :--- |
| **Trần Thành Lợi** | `25125059` | Tasks 4, 5, 6, 7 | **Lead Report Author & Core Architect:** General & Domain Design, Class Diagrams, Modern C++ Implementation (`MediatorPattern.cpp`). |
| **Huỳnh Trần Gia Hân** | `25125043` | Tasks 1, 2, 3, 8, 9, 10 | **Problem Analyst & Domain Evaluator:** Problem Statement, Naive Solution (`MediatorNaive.cpp`), Architectural Flaws Analysis, Pros/Cons, Real-World Applications, Interactive Quiz. |
